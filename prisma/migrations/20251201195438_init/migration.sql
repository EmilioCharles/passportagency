...
-- CreateEnum
CREATE TYPE "ApplicationType" AS ENUM ('REGULAR', 'BUSINESS', 'DIPLOMATIC', 'VISA');

-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'IN_REVIEW', 'APPROVED', 'REJECTED', 'COMPLETED');

-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('PASSPORT_PHOTO', 'ID_CARD', 'BIRTH_CERTIFICATE', 'PROOF_OF_PAYMENT', 'OTHER');
